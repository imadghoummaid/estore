...
define('FRONT_CSS', '/front/css/');
define('FRONT_JS', '/front/js/');
...
defined('SESSION_CIPHER_ALGO')     ? null : define ('SESSION_CIPHER_ALGO', 'AES-128-ECB');
defined('SESSION_CIPHER_KEY')      ? null : define ('SESSION_CIPHER_KEY', 'WYCRYPT0K3Y@2016');
